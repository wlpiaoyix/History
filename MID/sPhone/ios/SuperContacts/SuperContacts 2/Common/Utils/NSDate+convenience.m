...
-(NSString *)getFriendlyTime:(bool) ifDisplayDate{
    ...
    today = [today stringByAppendingString:[self dateFormateDate:@"HH:mm"]];
    NSString *time = @"";
    NSDate *currentDate = [NSDate new];
    if(currentDate.year==self.year){
        if(currentDate.day==self.day){
            time = [time stringByAppendingString:@"今天 "];
            time = [time stringByAppendingString:today];
            ...
            time = [time stringByAppendingString:[self dateFormateDate:@"MM-dd"]];
        }
    }else{
        time = [time stringByAppendingString:[self dateFormateDate:@"MM-dd"]];
    }
