...
#define COMMON_DATABASE_NAME @"database01"//数据库名称
...
//<==
//==>HTTP HOST API
#define COMMON_HTTP_URL_SUFFIX @"/api"//@"/sp/api"//
#define COMMON_HTTP_BASE_URL  @"10.10.10.48"//@"merp.inf.aksl.com.cn"//
#define COMMON_APP_API_PORT 3386//8023//
