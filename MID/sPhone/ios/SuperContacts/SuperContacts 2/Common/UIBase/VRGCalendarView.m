...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.933 green:0.965 blue:0.910 alpha:1].CGColor);
   ...
   // dateFormatter.dateFormat=@"EEE";
    ...
    NSMutableArray *weekdays = [[NSMutableArray alloc] initWithObjects:@"周日",@"周一",@"周二",@"周三",@"周四",@"周五",@"周六", nil];
    ...
    CGContextSetFillColorWithColor(context,[UIColor colorWithRed:0.969 green:0.969 blue:0.969 alpha:1].CGColor);
    CGContextFillPath(context);
   ...
   CGContextMoveToPoint(context, 0, kVRGCalendarViewTopBarHeight);
    ...
    //Draw markings
    if (!self.markedDates || isSelectedDatePreviousMonth || isSelectedDateNextMonth){}else{
        ...
        for (int i = 0; i<[self.markedDates count]; i++) {
            ...
            //            CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.678 green:0.863 blue:0.455 alpha:1].CGColor);
            ...
            CGContextSetLineWidth(context, 1);
            CGContextSetStrokeColorWithColor(context,[UIColor colorWithRed:0.525 green:0.714 blue:0.082 alpha:1].CGColor);
            CGContextAddEllipseInRect(context, rectangleGrid);
            CGContextStrokePath(context);
...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        if (selectedDate && i==selectedDateBlock) {
            ...
            CGRect rectangleGrid = CGRectMake(targetX+18,targetY+33,8,2);
            CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.525 green:0.714 blue:0.082 alpha:1].CGColor);
            CGContextAddRect(context, rectangleGrid);
            CGContextFillPath(context);
           CGContextSetFillColorWithColor(context,
                                           [UIColor colorWithHexString:@"0x383838"].CGColor);
        ...
        [date drawInRect:CGRectMake(targetX, targetY+12, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withFont:[UIFont fontWithName:@"HelveticaNeue" size:15] lineBreakMode:NSLineBreakByClipping alignment:NSTextAlignmentCenter];
    }
...
-(id)init {
    ...
    if (self) {
        ...
        labelCurrentMonth.backgroundColor=[UIColor colorWithRed:0.933 green:0.965 blue:0.910 alpha:1];
