...
#import "EntityUser.h"
@interface EntityCallRecord : NSObject <EntityInterface>
@property int recordId;//主键
@property NSString *callPhoneNum;//操作对应的电话号码
@property int recordTime;//通话时间
@property int statusCall;//通话状态 0 :打入 未接 1:打出未接 2:打入已接 3:打出已接
@property (nonatomic)EntityUser *entityUser;//当前记录触发对象
@property NSDate *createTime;//创建时间
