...
@property (strong, nonatomic) IBOutlet UIButton *buttonCitySelected;
...
//    [_viewEnterpriseType setPagingEnabled:YES];
    ...
    [_buttonCitySelected addTarget:self action:@selector(clickSelectedCity:) forControlEvents:UIControlEventTouchUpInside];
...
-(void) clickSelectedCity:(id) sender{
