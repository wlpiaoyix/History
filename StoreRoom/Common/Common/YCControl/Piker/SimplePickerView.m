...
@property (nonatomic,strong) SimplePickerTable *table;
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    if (_delegate) {
        return [self.delegate PickerNumberOfRows:self];
    }
    return 0;
}
...
-(void) setMutipleValue:(float)mutipleValue{
    ...
    _table.mutipleValue = _mutipleValue;
}
