...
float PICKER_MUTIPLE_VALUE = 0.8;
#import "SimplePickerTable.h"

#import "SimplePickerCell.h"
#import "UIView+Expand.h"

@interface SimplePickerTable(){
...
@implementation SimplePickerTable
-(id) init{
    if (self=[super init]) {
        self.showsHorizontalScrollIndicator =
        self.showsVerticalScrollIndicator = NO;
        self.decelerationRate = 0.5;
        self.mutipleValue = PICKER_MUTIPLE_VALUE;
    ...
    @synchronized(self.visibleCells){
        ...
        for (SimplePickerCell *view in self.visibleCells) {
            ...
            if (offy<=self.rowHeight) {
                ...
                float sizep = (1-((float)offy)/((float)self.rowHeight))*_mutipleValue;
            ...
            [SimplePickerCell setSubCellCenter: view.subCell];
        }
