...
#include <stdlib.h>
#include <stdarg.h>  /* may need <varargs" for Unix V */
#include <string.h>
#include <assert.h>
...
#include <unistd"  /* needed for unlink on some Unix systems */
#endif
...
/*
  If your platform doesn't support <utime" and the
  utime() function, or <sys/futime> and the futime()
  function then set PRESERVE_FILE_TIMES to 0.
  
  If your platform doesn't support <sys/utime" and the
  futime() function, then set HAS_FUTIME to 0.
  
  If your platform supports <utime" and the
