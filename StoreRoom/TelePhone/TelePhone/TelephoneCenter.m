...
+(NSString*) requestCallWithRecipient:(NSString*) recipients{
    NSString *result = nil;
...
+(NSString*) requestSMSWithRecipient:(NSString*) recipients{
    NSString *result = nil;
    if([self matchRecipient:recipients]){
...
+(NSString*)requestSMSWithRecipients:(NSArray*) recipients message:(NSString*) message{
    ...
    [[Utils getCurrentController] presentViewController:picker animated:YES completion:^{
        NSLog(@"");
    }];
}
...
- (void)messageComposeViewController:(MFMessageComposeViewController *)controller didFinishWithResult:(MessageComposeResult)result{
    ...
    [[Utils getCurrentController] dismissViewControllerAnimated:YES completion:^{
